...
## [2.168.0](https://github.com/klajdi369/auth/compare/v2.167.0...v2.168.0) (2025-01-06)
...
* add email validation function to lower bounce rates ([#1845](https://github.com/klajdi369/auth/issues/1845)) ([2c291f0](https://github.com/klajdi369/auth/commit/2c291f0356f3e91063b6b43bf2a21625b0ce0ebd))
...
* add haveibeenpwned.org password strength check ([#1324](https://github.com/klajdi369/auth/issues/1324)) ([c3acfe7](https://github.com/klajdi369/auth/commit/c3acfe7cf4d17a3fdf98bd6376cd9a4ae645564b))
...
* add mail header support via `GOTRUE_SMTP_HEADERS` with `$messageType` ([#1804](https://github.com/klajdi369/auth/issues/1804)) ([99d6a13](https://github.com/klajdi369/auth/commit/99d6a134c44554a8ad06695e1dff54c942c8335d))
...
* add MFA for WebAuthn ([#1775](https://github.com/klajdi369/auth/issues/1775)) ([8cc2f0e](https://github.com/klajdi369/auth/commit/8cc2f0e14d06d0feb56b25a0278fda9e213b6b5a))
...
* add support for migration of firebase scrypt passwords ([#1768](https://github.com/klajdi369/auth/issues/1768)) ([ba00f75](https://github.com/klajdi369/auth/commit/ba00f75c28d6708ddf8ee151ce18f2d6193689ef))
...
* add support for Slack OAuth V2 ([#1591](https://github.com/klajdi369/auth/issues/1591)) ([bb99251](https://github.com/klajdi369/auth/commit/bb992519cdf7578dc02cd7de55e2e6aa09b4c0f3))
...
* configurable email and sms rate limiting ([#1800](https://github.com/klajdi369/auth/issues/1800)) ([5e94047](https://github.com/klajdi369/auth/commit/5e9404717e1c962ab729cde150ef5b40ea31a6e8))
...
* expose email address being sent to for email change flow ([#1231](https://github.com/klajdi369/auth/issues/1231)) ([f7308ad](https://github.com/klajdi369/auth/commit/f7308ad9355db7526a30798b8aa17dabff9f543b))
...
* fix argon2 parsing and comparison ([#1887](https://github.com/klajdi369/auth/issues/1887)) ([9dbe6ef](https://github.com/klajdi369/auth/commit/9dbe6ef931ae94e621d55a5f7aea4b7ee0449949))
...
* mailer logging ([#1805](https://github.com/klajdi369/auth/issues/1805)) ([9354b83](https://github.com/klajdi369/auth/commit/9354b83a48a3edcb49197c997a1e96efc80c5383))
...
* preserve rate limiters in memory across configuration reloads ([#1792](https://github.com/klajdi369/auth/issues/1792)) ([0a3968b](https://github.com/klajdi369/auth/commit/0a3968b02b9f044bfb7e5ebc71dca970d2bb7807))
...
* refactor one-time tokens for performance ([#1558](https://github.com/klajdi369/auth/issues/1558)) ([d1cf8d9](https://github.com/klajdi369/auth/commit/d1cf8d9096e9183d7772b73031de8ecbd66e912b))
...
* return validation failed error if captcha request was not json ([#1815](https://github.com/klajdi369/auth/issues/1815)) ([26d2e36](https://github.com/klajdi369/auth/commit/26d2e36bba29eb8a6ddba556acfd0820f3bfde5d))
...
* spotify oauth ([#1296](https://github.com/klajdi369/auth/issues/1296)) ([cc07b4a](https://github.com/klajdi369/auth/commit/cc07b4aa2ace75d9c8e46ae5107dbabadf944e87))
...
* switch to googleapis/release-please-action, bump to 2.166.0 ([#1883](https://github.com/klajdi369/auth/issues/1883)) ([11a312f](https://github.com/klajdi369/auth/commit/11a312fcf77771b3732f2f439078225895df7a85))
...
* use embedded migrations for `migrate` command ([#1843](https://github.com/klajdi369/auth/issues/1843)) ([e358da5](https://github.com/klajdi369/auth/commit/e358da5f0e267725a77308461d0a4126436fc537))
...
* add error codes to refresh token flow ([#1824](https://github.com/klajdi369/auth/issues/1824)) ([4614dc5](https://github.com/klajdi369/auth/commit/4614dc54ab1dcb5390cfed05441e7888af017d92))
...
* add test coverage for rate limits with 0 permitted events ([#1834](https://github.com/klajdi369/auth/issues/1834)) ([7c3cf26](https://github.com/klajdi369/auth/commit/7c3cf26cfe2a3e4de579d10509945186ad719855))
...
* add twilio verify support on mfa ([#1714](https://github.com/klajdi369/auth/issues/1714)) ([aeb5d8f](https://github.com/klajdi369/auth/commit/aeb5d8f8f18af60ce369cab5714979ac0c208308))
...
* apply authorized email restriction to non-admin routes ([#1778](https://github.com/klajdi369/auth/issues/1778)) ([1af203f](https://github.com/klajdi369/auth/commit/1af203f92372e6db12454a0d319aad8ce3d149e7))
...
* apply shared limiters before email / sms is sent ([#1748](https://github.com/klajdi369/auth/issues/1748)) ([bf276ab](https://github.com/klajdi369/auth/commit/bf276ab49753642793471815727559172fea4efc))
* bypass check for token & verify endpoints ([#1785](https://github.com/klajdi369/auth/issues/1785)) ([9ac2ea0](https://github.com/klajdi369/auth/commit/9ac2ea0180826cd2f65e679524aabfb10666e973))
...
* check if session is nil ([#1873](https://github.com/klajdi369/auth/issues/1873)) ([fd82601](https://github.com/klajdi369/auth/commit/fd82601917adcd9f8c38263953eb1ef098b26b7f))
...
* correct web authn aaguid column naming ([#1826](https://github.com/klajdi369/auth/issues/1826)) ([0a589d0](https://github.com/klajdi369/auth/commit/0a589d04e1cd9310cb260d329bc8beb050adf8da))
...
* default to files:read scope for Figma provider ([#1831](https://github.com/klajdi369/auth/issues/1831)) ([9ce2857](https://github.com/klajdi369/auth/commit/9ce28570bf3da9571198d44d693c7ad7038cde33))
...
* email header setting no longer misleading ([#1802](https://github.com/klajdi369/auth/issues/1802)) ([3af03be](https://github.com/klajdi369/auth/commit/3af03be6b65c40f3f4f62ce9ab989a20d75ae53a))
* email_verified field not being updated on signup confirmation ([#1868](https://github.com/klajdi369/auth/issues/1868)) ([483463e](https://github.com/klajdi369/auth/commit/483463e49eec7b2974cca05eadca6b933b2145b5))
...
* enforce authorized address checks on send email only ([#1806](https://github.com/klajdi369/auth/issues/1806)) ([c0c5b23](https://github.com/klajdi369/auth/commit/c0c5b23728c8fb633dae23aa4b29ed60e2691a2b))
* enforce code challenge validity across endpoints ([#1026](https://github.com/klajdi369/auth/issues/1026)) ([be7c082](https://github.com/klajdi369/auth/commit/be7c082cad77176dd1bc987e90fdd1502eafdd67))
...
* external host validation ([#1808](https://github.com/klajdi369/auth/issues/1808)) ([4f6a461](https://github.com/klajdi369/auth/commit/4f6a4617074e61ba3b31836ccb112014904ce97c)), closes [#1228](https://github.com/klajdi369/auth/issues/1228)
* fallback on btree indexes when hash is unavailable ([#1856](https://github.com/klajdi369/auth/issues/1856)) ([b33bc31](https://github.com/klajdi369/auth/commit/b33bc31c07549dc9dc221100995d6f6b6754fd3a))
* fix `getExcludedColumns` slice allocation ([#1788](https://github.com/klajdi369/auth/issues/1788)) ([7f006b6](https://github.com/klajdi369/auth/commit/7f006b63c8d7e28e55a6d471881e9c118df80585))
...
* Fix reqPath for bypass check for verify EP ([#1789](https://github.com/klajdi369/auth/issues/1789)) ([646dc66](https://github.com/klajdi369/auth/commit/646dc66ea8d59a7f78bf5a5e55d9b5065a718c23))
...
* handle user banned error code ([#1851](https://github.com/klajdi369/auth/issues/1851)) ([a6918f4](https://github.com/klajdi369/auth/commit/a6918f49baee42899b3ae1b7b6bc126d84629c99))
...
* ignore rate limits for autoconfirm ([#1810](https://github.com/klajdi369/auth/issues/1810)) ([9ce2340](https://github.com/klajdi369/auth/commit/9ce23409f960a8efa55075931138624cb681eca5))
...
* improve error messaging for http hooks ([#1821](https://github.com/klajdi369/auth/issues/1821)) ([fa020d0](https://github.com/klajdi369/auth/commit/fa020d0fc292d5c381c57ecac6666d9ff657e4c4))
...
* inline mailme package for easy development ([#1803](https://github.com/klajdi369/auth/issues/1803)) ([fa6f729](https://github.com/klajdi369/auth/commit/fa6f729a027eff551db104550fa626088e00bc15))
* invalidate email, phone OTPs on password change ([#1489](https://github.com/klajdi369/auth/issues/1489)) ([960a4f9](https://github.com/klajdi369/auth/commit/960a4f94f5500e33a0ec2f6afe0380bbc9562500))
...
* make drop_uniqueness_constraint_on_phone idempotent ([#1817](https://github.com/klajdi369/auth/issues/1817)) ([158e473](https://github.com/klajdi369/auth/commit/158e4732afa17620cdd89c85b7b57569feea5c21))
...
* pass through redirect query parameters ([#1224](https://github.com/klajdi369/auth/issues/1224)) ([577e320](https://github.com/klajdi369/auth/commit/577e3207aab8ee4c4661f5a8148f02296210f1d8))
...
* possible panic if refresh token has a null session_id ([#1822](https://github.com/klajdi369/auth/issues/1822)) ([a7129df](https://github.com/klajdi369/auth/commit/a7129df4e1d91a042b56ff1f041b9c6598825475))
...
* rate limits of 0 take precedence over MAILER_AUTO_CONFIRM ([#1837](https://github.com/klajdi369/auth/issues/1837)) ([cb7894e](https://github.com/klajdi369/auth/commit/cb7894e1119d27d527dedcca22d8b3d433beddac))
...
* refactor mfa validation into functions ([#1780](https://github.com/klajdi369/auth/issues/1780)) ([410b8ac](https://github.com/klajdi369/auth/commit/410b8acdd659fc4c929fe57a9e9dba4c76da305d))
...
* resend email change & phone change issues ([#1100](https://github.com/klajdi369/auth/issues/1100)) ([184fa38](https://github.com/klajdi369/auth/commit/184fa38f0f90b7a7c6d7c9c4c8a1a087f5e9b453))
...
* return the error code instead of status code ([#1855](https://github.com/klajdi369/auth/issues/1855)) ([834a380](https://github.com/klajdi369/auth/commit/834a380d803ae9ce59ce5ee233fa3a78a984fe68))
...
* Revert "fix: revert fallback on btree indexes when hash is unavailable" ([#1859](https://github.com/klajdi369/auth/issues/1859)) ([9fe5b1e](https://github.com/klajdi369/auth/commit/9fe5b1eebfafb385d6b5d10196aeb2a1964ab296))
...
* revert fallback on btree indexes when hash is unavailable ([#1858](https://github.com/klajdi369/auth/issues/1858)) ([1c7202f](https://github.com/klajdi369/auth/commit/1c7202ff835856562ee66b33be131eca769acf1d))
...
* skip cleanup for non-2xx status ([#1877](https://github.com/klajdi369/auth/issues/1877)) ([f572ced](https://github.com/klajdi369/auth/commit/f572ced3699c7f920deccce1a3539299541ec94c))
...
* take into account test otp for twilio verify ([#1255](https://github.com/klajdi369/auth/issues/1255)) ([18b4291](https://github.com/klajdi369/auth/commit/18b4291ea00eb0f95229f5dbe5d6474c1e563b4d))
...
* update ip mismatch error message ([#1849](https://github.com/klajdi369/auth/issues/1849)) ([49fbbf0](https://github.com/klajdi369/auth/commit/49fbbf03917a1085c58e9a1ff76c247ae6bb9ca7))
...
* upgrade ci Go version ([#1782](https://github.com/klajdi369/auth/issues/1782)) ([97a48f6](https://github.com/klajdi369/auth/commit/97a48f6daaa2edda5b568939cbb1007ccdf33cfc))
...
* use signing jwk to sign oauth state ([#1728](https://github.com/klajdi369/auth/issues/1728)) ([66fd0c8](https://github.com/klajdi369/auth/commit/66fd0c8434388bbff1e1bf02f40517aca0e9d339))
...
* validateEmail should normalise emails ([#1790](https://github.com/klajdi369/auth/issues/1790)) ([2e9b144](https://github.com/klajdi369/auth/commit/2e9b144a0cbf2d26d3c4c2eafbff1899a36aeb3b))
